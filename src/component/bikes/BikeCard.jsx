...
export const BikeCard = ({ bike, bikeListMode }) => {
    ...
    return (
        <div className="mb-4">
            ...
            <div className="row">
                ...
                <div className="col-lg-4 d-flex align-items-center" style={{ color: bikeListMode === 'light' ? 'black' : 'white' }}>
            ...
            <div>
                {
                    showMoreDetails &&
                    <div className="mt-2">
                        <b style={{ color: bikeListMode === 'light' ? 'black' : 'white' }}>Details:</b>
